...
export const PaymentHero = () => {
  ...
  return (
    <div ref={ref} className="container mx-auto px-4 lg:px-8 overflow-hidden pb-0">
      <div className="max-w-7xl mx-auto">
        <motion.div 
          ...
          className="text-left lg:text-center mb-4 sm:mb-16 mt-8 sm:mt-12 relative transform-gpu will-change-transform"
        >
          <motion.div 
            ...
            className="inline-flex items-center gap-2 mb-4 sm:mb-8 px-3 sm:px-6 py-1.5 sm:py-3 rounded-full bg-gradient-to-r from-violet-500/10 to-indigo-500/10 border border-violet-500/20 text-violet-700 dark:text-violet-300 text-[10px] sm:text-sm font-black uppercase tracking-[0.1em] sm:tracking-[0.2em] shadow-sm backdrop-blur-md"
          >
            <Sparkles className="w-3 h-3 sm:w-4 sm:h-4 text-violet-500 animate-pulse" />
            <span>Real-Time SKU Intelligence with AI</span>
          </motion.div>

          <h2 className="text-2xl sm:text-4xl md:text-5xl lg:text-7xl font-black font-display mb-4 sm:mb-8 md:mb-10 tracking-tight leading-[1.2] sm:leading-[1.15] px-2 sm:px-0 relative group">
          ...
          <p className="text-[13px] sm:text-lg md:text-xl lg:text-2xl text-slate-600 dark:text-slate-300 max-w-4xl mx-auto mb-10 sm:mb-10 md:mb-12 leading-relaxed font-bold tracking-tight px-4 sm:px-6 lg:px-0">
          ...
          <motion.div 
            ...
            whileInView="visible"
            viewport={{ once: true }}
            className="grid grid-cols-2 lg:grid-cols-4 items-center justify-center gap-3 sm:gap-4 md:gap-6 lg:gap-4 mb-0 sm:mb-16 px-2 sm:px-4 transform-gpu will-change-transform"
          >
            {[
