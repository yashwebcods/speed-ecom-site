...
export function Services() {
  ...
  return (
    <section id="services" className="py-20 lg:py-32 bg-card relative overflow-hidden" ref={sectionRef}>
      ...
      <div className="container mx-auto px-4 lg:px-8">
        ...
        >
          ...
          <h2 className="text-3xl lg:text-5xl font-bold font-display mb-4 text-balance">
