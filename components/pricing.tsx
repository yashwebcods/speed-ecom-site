...
const pricingTiers = [
  {
    ...
    price: "₹249",
    period: "/month",
    description: "Essential tools for single-platform sellers to track profits and recover lost revenue.",
    features: [
      ...
      { name: "Hidden Charges Detection", included: true },
      { name: "Dedicated Relationship Manager", included: true },
      { name: "Return Reconciliation", included: false },
    ],
    highlighted: false,
  ...
  },
  {
    ...
    price: "₹499",
    period: "/month",
    description: "Advanced multi-platform auditing and ROI analysis for rapidly scaling e-commerce brands.",
    features: [
      { name: "Up to 3 Marketplace Integrations", included: true },
      { name: "Monthly Profit/Loss Report", included: true },
      { name: "Wrong Commission Detection", included: true },
      { name: "Hidden Charges Detection", included: true },
      { name: "Return Reconciliation & SKU Tracking", included: true },
  ...
  },
  {
    ...
    price: "Custom",
    period: "",
    description: "A full-scale financial operations suite with custom reporting and priority support for high-volume retailers.",
    features: [
      { name: "Unlimited Marketplace Integrations", included: true },
      { name: "Real-time Profit/Loss Dashboard", included: true },
      { name: "Automated Return Claim Tracking", included: true },
      { name: "Priority 24/7 Support", included: true },
      { name: "High Shipping Charge Detection", included: true },
